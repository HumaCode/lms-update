...
export default function VideoDisplay({ activeLesson }) {
    if (!activeLesson) {
        return (
            <div className="video_holder d-flex align-items-center justify-content-center bg-black text-muted" style={{ height: '520px' }}>
    ...
    return (
        <div className="video_holder bg-black overflow-hidden position-relative" style={{ width: '100%', height: '520px' }}>
