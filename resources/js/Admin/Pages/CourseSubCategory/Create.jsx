...
export default function Create({ category }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('admin.course-sub-categories.store', category.id));
    };

    return (
        <AdminLayout>
            <Head title={`Create Sub-Category - ${category.name}`} />

            <PageHeader
                title={`Create Sub-Category for "${category.name}"`}
                breadcrumbs={[
                            ...
                            <div className="card-body">
                                <div className="mb-3">
                                    ...
                                    <input
                                        ...
                                        placeholder="e.g. React.js, Web Design, Data Analytics"
                                        value={data.name}
                                ...
                                <div className="mb-3">
                                    <label className="form-label">Icon Class (e.g. ti ti-code, fa fa-book)</label>
                                    <input
                                        type="text"
                                        className={`form-control ${errors.icon ? 'is-invalid' : ''}`}
                                        placeholder="ti ti-code"
                                        value={data.icon}
